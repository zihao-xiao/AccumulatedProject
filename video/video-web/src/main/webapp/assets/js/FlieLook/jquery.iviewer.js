    ...
    **/
    createui: function()
    {
        ...
        $("<div>", { 'class': "iviewer_rotate_right iviewer_common iviewer_button" })
                    .bind('mousedown touchstart',function(){me.angle(90); return false;})
                    .appendTo(this.container);
//        $("<div>", { 'class': "iviewer_uppage iviewer_common iviewer_button" })
//                    .bind('mousedown touchstart', function () { upimg(); return false; })
//                    .appendTo(this.container);
//        $("<div>", { 'class': "iviewer_nextpage iviewer_common iviewer_button" })
//                    .bind('mousedown touchstart', function () { nextimg(); return false; })
//                    .appendTo(this.container);
