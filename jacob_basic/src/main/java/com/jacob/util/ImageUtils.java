...
public class ImageUtils {  
    ...
    public static void main(String[] args) {  
         // 1-缩放图像：  
        // 方法一：按比例缩放  
        ImageUtils.scale("F:/ceshi/scale_cut.jpg", "F:/ceshi/scale_fangda.jpg", 2, true);//测试OK<span style="font-family: Arial, Helvetica, sans-serif;">（2为缩放比例，若为1则没有放大也没有缩小；放大为true，缩小为false）</span>  
        // 方法二：按高度和宽度缩放  
        //ImageUtils.scale2("F:/ceshi/scale.jpg", "F:/ceshi/scale_cut1.jpg", 190, 1180, true);//测试OK（190为高度，1180为宽度）  
        // 2-切割图像：  
        // 方法一：按指定起点坐标和宽高切割  
        //ImageUtils.cut("F:/ceshi/scale.jpg", "F:/ceshi/scale_cut2.jpg", 0, 0, 1180, 190 );//测试OK<span style="font-family: Arial, Helvetica, sans-serif;">（190为高度，1180为宽度）</span>  
  
        // 方法二：指定切片的行数和列数  
       // ImageUtils.cut2("e:/abc.jpg", "e:/", 2, 2 );//测试OK  
        // 方法三：指定切片的宽度和高度  
        //ImageUtils.cut3("F:/ceshi/scale_cut.jpg", "F:/ceshi/scale_fangda.jpg", 1180, 190 );//测试OK  
        // 3-图像类型转换：  
